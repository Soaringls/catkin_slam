...
private:
  void initialize_params() {
    ...
    pclomp::NormalDistributionsTransform<PointT, PointT>::Ptr 
...
private:
  ...
  void points_callback(const sensor_msgs::PointCloud2ConstPtr& points_msg) {
    ...
    double avg_processing_time = std::accumulate(processing_time.begin(), 
                                                 processing_time.end(), 0.0) / processing_time.size();
   ...
   * @return transform
   */
  geometry_msgs::TransformStamped matrix2transform(const ros::Time& stamp, 
