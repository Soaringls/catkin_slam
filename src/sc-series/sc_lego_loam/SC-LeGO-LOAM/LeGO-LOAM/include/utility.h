...
using namespace std;
// rosbag filter "HK-Data20190316-2 20190331_NJ_LL.bag"
// "lidaronly_HK-Data20190316-2 20190331_NJ_LL.bag" "topic ==
// '/velodyne_points'" rosbag filter "HK-Data20190117.bag"
// "lidaronly_HK-Data20190117.bag" "topic == '/velodyne_points'"
...
extern const float historyKeyframeSearchRadius =
    20.0;  // NOT used in Scan Context-based loop detector / default 7.0; key
           // frame that is within n meters from current pose will be considerd
           // for loop closure
extern const int historyKeyframeSearchNum =
    25;  // 2n+1 number of history key frames will be fused into a submap for
         // loop closure
extern const float historyKeyframeFitnessScore =
    1.5;  // default 0.3; the smaller the better alignment

extern const float globalMapVisualizationSearchRadius =
    1500.0;  // key frames with in n meters will be visualized
