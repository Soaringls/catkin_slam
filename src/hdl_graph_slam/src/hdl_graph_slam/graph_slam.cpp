...
g2o::EdgeSE3* GraphSLAM::add_se3_edge(g2o::VertexSE3* v1, //current
                                      g2o::VertexSE3* v2, //pre
                                      const Eigen::Isometry3d& relative_pose, //tf测量值 pre在current中坐标
                                      const Eigen::MatrixXd& information_matrix) {
  g2o::EdgeSE3* edge(new g2o::EdgeSE3());
  edge->setMeasurement(relative_pose);
  edge->setInformation(information_matrix);
  edge->vertices()[0] = v1; //current
  edge->vertices()[1] = v2; //pre
  graph->addEdge(edge);
...
//gps utm
g2o::EdgeSE3PriorXYZ* GraphSLAM::add_se3_prior_xyz_edge(g2o::VertexSE3* v_se3, 
                                                        const Eigen::Vector3d& xyz, //关键帧utm坐标(第一帧从原点开始)
                                                        const Eigen::MatrixXd& information_matrix) {
...
//imu-acc
g2o::EdgeSE3PriorVec* GraphSLAM::add_se3_prior_vec_edge(g2o::VertexSE3* v_se3, 
                                                        const Eigen::Vector3d& direction, 
                                                        const Eigen::Vector3d& measurement, //line_acc
                                                        const Eigen::MatrixXd& information_matrix) {
...
//imu-orientation
g2o::EdgeSE3PriorQuat* GraphSLAM::add_se3_prior_quat_edge(g2o::VertexSE3* v_se3, 
