 ...
 public:
  ...
  void imuOdometryHandler(const nav_msgs::Odometry::ConstPtr& odomMsg) {
    ...
    Eigen::Affine3f imuOdomAffineIncre =
        imuOdomAffineFront.inverse() * imuOdomAffineBack;  //短时间内trans
    ...
    pubImuOdometry.publish(
        laserOdometry);  // pub topic: lio_sam/odomTopic 最后好的pose
    ...
    tf::StampedTransform odom_2_baselink =
        tf::StampedTransform(tCur, odomMsg->header.stamp, odometryFrame,
                             baselinkFrame);  // odom base_link
...
class IMUPreintegration : public ParamServer {
 public:
  ...
  IMUPreintegration() {
    ...
    pubImuOdometry_ImuPreintegration =
