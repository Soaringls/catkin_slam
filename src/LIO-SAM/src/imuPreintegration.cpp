...
class TransformFusion : public ParamServer {
 public:
  ...
  TransformFusion() {
    ...
    //-------->pub
    pubImuOdometry =
        nh.advertise<nav_msgs::Odometry>(odomTopic, 2000);  // odometry/imu
    pubImuPath =
        nh.advertise<nav_msgs::Path>("lio_sam/imu/path", 1);  // local path
  }
  ...
  void imuOdometryHandler(const nav_msgs::Odometry::ConstPtr& odomMsg) {
    ...
    // pub topic: lio_sam/odomTopic 最后好的pose
...
class IMUPreintegration : public ParamServer {
 public:
  ...
  IMUPreintegration() {
    ...
    //-------->pub
    pubImuOdometry_ImuPreintegration = nh.advertise<nav_msgs::Odometry>(
        odomTopic + "_incremental", 2000);  // "/odometry/imu_incremental"
    ...
    p->accelerometerCovariance =
        ...
        pow(imuAccNoise, 2);  // acc white noise in continuous 离散不连续的
  ...
  void imuHandler(const sensor_msgs::Imu::ConstPtr& imu_raw) {
    ...
    pubImuOdometry_ImuPreintegration.publish(
        odometry);  // pub-topic:"lio_sam/odomTopic_incremental"
  }
};
