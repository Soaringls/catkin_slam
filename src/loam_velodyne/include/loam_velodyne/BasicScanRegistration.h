...
namespace loam
{
  ...
  private:
    ...
    Time _scanTime;              ///< time stamp of most recent scan 当前帧点云的起点时间戳
    ...
    std::vector<size_t> _regionSortIndices;   ///< sorted region indices based on point curvature 曲率升序排列的全局的索引
