...
function local_volumes() {
    ...
    #volumes="-v ${AUTOBOT_ROOT_DIR}:/cybertron"
    #volumes="-v ${AUTOBOT_ROOT_DIR}:/autobot"
    volumes="-v ${AUTOBOT_ROOT_DIR}/:/autobot/ \
	     -v ${AUTOBOT_ROOT_DIR}/gears:/autobot/gears \
	     -v ${AUTOBOT_ROOT_DIR}/cyber:/autobot/cyber \
	     -v ${AUTOBOT_ROOT_DIR}/cyber_example:/autobot/cyber_example \
	     -v ${AUTOBOT_ROOT_DIR}/platform/docker:/autobot/docker \
	     -v ${AUTOBOT_ROOT_DIR}/cuda_env:/autobot/cuda_env \
	     -v ${AUTOBOT_ROOT_DIR}/opt:/autobot/opt \
	     -v ${AUTOBOT_ROOT_DIR}/opt_temp:/autobot/opt_temp"
